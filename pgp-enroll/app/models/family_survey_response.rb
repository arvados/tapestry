class FamilySurveyResponse < ActiveRecord::Base
  ...
  validates_inclusion_of :relatives_interested_in_pgp, :in => RELATIVES_INTERESTED_IN_PGP_VALUES,  :message => 'is invalid'
  validates_inclusion_of :monozygotic_twin,            :in => MONOZYGOTIC_TWIN_OPTIONS.values,     :message => 'is invalid'
  validates_inclusion_of :child_situation,             :in => CHILD_SITUATION_OPTIONS.values,      :message => 'is invalid'
